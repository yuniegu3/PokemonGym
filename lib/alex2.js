...
catchPokemon("4").then(catchPokemon("26")).then(catchPokemon("135")).then(function(result){
  ...
  trainer = new Trainer("trainer", pokeArray)
    ...
    console.log(trainer+"****")
    createContainer("charmander", "1")}).then(function(trainer){
    createContainer("raichu", "1")}).then(function(trainer){
    createContainer("jolteon", "1")}).then(function(trainer){
    signalLoad()});
